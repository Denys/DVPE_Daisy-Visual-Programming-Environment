...
Catalog summary: 174 blocks, 9 categories, 329 parameters, 227 CV-controllable parameters.
...
- [POLY GRAINLET (poly_grainlet_voice)](#sources-poly-grainlet-polygrainletvoice) - Sources
...
### POLY GRAINLET `poly_grainlet_voice`

<a id="sources-poly-grainlet-polygrainletvoice"></a>

Daisy Field polyphonic Grainlet voice with built-in voice allocation

Class: `daisysp::PolyGrainletVoice`

Parameters: 9; CV-controllable: 6

| Parameter | CV | Type / range / default | Description |
|---|---:|---|---|
| `voice_count` Voices | - | int; 1..16 step 1; default 8; group Polyphony | Maximum number of allocated polyphonic voices |
| `octave` Octave | - | int; 0..4 step 1; default 2; group Keyboard | Base octave for the Daisy Field key scale |
| `shape` Shape | **CV** | float; 0..1 step 0.01; default 0.35; group Timbre | Grain window shape |
| `formant_freq` Formant | **CV** | float; 120..6000 Hz step 1 logarithmic; default 1200; group Timbre | Formant frequency |
| `bleed` Bleed | **CV** | float; 0..1 step 0.01; default 0.25; group Timbre | Inter-grain bleed amount |
| `attack` Attack | **CV** | float; 0.001..1.25 s step 0.001 logarithmic; default 0.01; group Envelope | Voice envelope attack time |
| `release` Release | **CV** | float; 0.02..2.5 s step 0.001 logarithmic; default 0.25; group Envelope | Voice envelope release time |
| `spread` Spread | **CV** | float; 0..1 step 0.01; default 0.4; group Stereo | Equal-power stereo spread by key position |
| `output_gain` Gain | - | float; 0..1 step 0.01; default 0.18; group Output | Post-sum safety gain |
