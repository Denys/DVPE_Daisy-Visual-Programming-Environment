...
export const OscillatorBankBlock: BlockDefinition = {
    ...
    ports: [
        ...
        {
            id: 'amp_saw_8_cv',
            displayName: 'SAW 8 CV',
            signalType: SignalType.CV,
            direction: PortDirection.INPUT,
            description: 'Sawtooth 8\' amplitude CV modulation',
        },
        {
            id: 'amp_sqr_8_cv',
            displayName: 'SQR 8 CV',
            signalType: SignalType.CV,
            direction: PortDirection.INPUT,
            description: 'Square 8\' amplitude CV modulation',
        },
        {
            id: 'amp_saw_4_cv',
            displayName: 'SAW 4 CV',
            signalType: SignalType.CV,
            direction: PortDirection.INPUT,
            description: 'Sawtooth 4\' amplitude CV modulation',
        },
        {
            id: 'amp_sqr_4_cv',
            displayName: 'SQR 4 CV',
            signalType: SignalType.CV,
            direction: PortDirection.INPUT,
            description: 'Square 4\' amplitude CV modulation',
        },
        {
            id: 'amp_saw_2_cv',
            displayName: 'SAW 2 CV',
            signalType: SignalType.CV,
            direction: PortDirection.INPUT,
            description: 'Sawtooth 2\' amplitude CV modulation',
        },
        {
            id: 'amp_sqr_2_cv',
            displayName: 'SQR 2 CV',
            signalType: SignalType.CV,
            direction: PortDirection.INPUT,
            description: 'Square 2\' amplitude CV modulation',
        },
        {
            id: 'amp_saw_1_cv',
            displayName: 'SAW 1 CV',
            signalType: SignalType.CV,
            direction: PortDirection.INPUT,
            description: 'Sawtooth 1\' amplitude CV modulation',
        },
        {
            id: 'gain_cv',
            displayName: 'GAIN CV',
            signalType: SignalType.CV,
            direction: PortDirection.INPUT,
            description: 'Output gain CV modulation',
        },
        {
            id: 'out',
            displayName: 'OUT',
