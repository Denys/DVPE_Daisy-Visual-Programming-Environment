 ...
 * Hardware slider/fader input access via ADC
 */
...
export const SliderBlock: BlockDefinition = {
    ...
    parameters: [
        {
            ...
            group: 'Hardware',
            description: 'ADC channel the slider is connected to',
        },
        {
            id: 'min',
            displayName: 'Min',
            ...
            cvModulatable: false,
            group: 'Scaling',
            description: 'Output value when slider is at minimum',
        },
        {
            id: 'max',
            displayName: 'Max',
            ...
            cvModulatable: false,
            group: 'Scaling',
            description: 'Output value when slider is at maximum',
        },
        {
            id: 'curve',
            displayName: 'Curve',
            ...
            group: 'Scaling',
            description: 'Response curve for the slider',
        },
    ],
    ...
    // Documentation
    description: 'Hardware slider/fader input',
    documentation: `
Reads analog input from a hardware ADC channel (slider, fader, etc.)
